...
const menuItems = {
    admin: [
      { name: "Manage Users", key: "users", icon: <FaUsers /> },
      { name: "Manage Documents", key: "documents", icon: <FaFileAlt /> },
      { name: "Revocation Requests", key: "revocations", icon: <FaBan /> },
      { name: "System Settings", key: "settings", icon: <FaCog /> },
      { name: "Activity Logs", key: "logs", icon: <FaListAlt /> },
    ],
  };
