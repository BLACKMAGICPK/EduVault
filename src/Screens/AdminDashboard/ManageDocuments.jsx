      ...
      <div className="page-container">
        ...
        <main className="page-main">
          ...
          <p className="welcome-text">
            View and manage all documents stored in the EduVault system.
          </p>
          ...
          {type === "ALL" ? "All Types" : type}
            ...
            {filteredDocs.length === 0 ? (
              ...
              filteredDocs.map((doc) => {
                ...
                return (
                  <div
                    className={`doc-vcard ${doc.status.toLowerCase()}`}
                    key={doc.documentId}
                  >
                    {/* STATUS */}
                    ...
                    <div className="student-qr-4col">
                      <div className="student-details-4col">
                        ...
                        <div className="meta-item">
                            ...
                            {doc.studentInfo?.institutionName}
                            </span>
                        </div>
...
/* FILTER SELECT */
.filter-select {
  padding: 0.45rem 2.2rem 0.45rem 0.9rem; /* ⬅ extra right padding */
  border-radius: 999px;
  border: 1.5px solid var(--gold);
  font-size: 0.75rem;
  font-weight: 700;
  ...
  background-position: right 0.9rem center; /* ⬅ arrow spacing */
