  ...
  const handleSubmit = async (e) => {
    ...
    /* -----------------------------------
          LOGIN SECTION (NEW API CALL)
    -------------------------------------*/
    if (isLogin) {
      let endpoint = "";

      if (activeRole === "Student") endpoint = `${BASE_URL}/login-student`;
      if (activeRole === "Admin") endpoint = `${BASE_URL}/login-admin`;
      if (activeRole === "Verifier") endpoint = `${BASE_URL}/login-verifier`;
...
if (response.ok) {
  ...
  if (activeRole === "Verifier") {
    navigate("/verifier-dashboard/profile");
  }
}
    ...
    /* -----------------------------------
          SIGNUP SECTION (Existing Working)
    -------------------------------------*/
    let endpoint = "";

    if (activeRole === "Student") endpoint = `${BASE_URL}/signup-student`;
    if (activeRole === "Admin") endpoint = `${BASE_URL}/signup-admin`;
    if (activeRole === "Verifier") endpoint = `${BASE_URL}/signup-verifier`;
...
if (response.ok) {
  toast.success(`${activeRole} Signup Successful!`);
